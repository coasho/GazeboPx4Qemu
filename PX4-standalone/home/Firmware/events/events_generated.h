...
enum class battery_fault_reason_t : uint8_t {
	...
	failed_to_arm = 10, ///< Battery failed to arm
	cell_fail = 2, ///< One or more battery cells have failed
	over_current = 3, ///< Battery reported over-current
	over_temperature = 4, ///< Battery has reached a critical temperature which can result in a critical failure
	under_temperature = 5, ///< Battery temperature is below operating range
	incompatible_voltage = 6, ///< Voltage mismatch, use equally charged batteries
