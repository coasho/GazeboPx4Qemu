...
alias septentrio='px4-septentrio --instance $px4_instance'
...
alias sensor_agp_sim='px4-sensor_agp_sim --instance $px4_instance'
...
alias system_power_simulator='px4-system_power_simulator --instance $px4_instance'
